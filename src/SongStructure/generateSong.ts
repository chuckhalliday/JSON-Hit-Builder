...
import { primaryGroove, bassArray1V, bassArray2V, bassArray3V, bassArray4V,
...
export default function generateSong(){
  ...
  const bassLine1V: string[] = bassArray1V(bassPart1);
  const bassLine2V: string[] = bassArray2V(bassPart2, bassLine1V);
  const bassLine3V: string[] = bassArray3V(bassPart3, bassLine2V);
  const bassLine4V: string[] = bassArray4V(bassPart4, bassLine1V);
  const bassV: string[] = bassLine1V.concat(bassLine2V, bassLine3V, bassLine4V);

  const chordsV: string = chordArray(initChords, initBass, bassV)
  ...
  const bassLine1C: string[] = bassArray1C(bassPart2, bassLine1V);
  const bassLine2C: string[] = bassArray2C(bassPart1, bassLine1C);
  const bassLine3C: string[] = bassArray3C(bassPart4, bassLine1V);
  const bassLine4C: string[] = bassArray4C(bassPart3, bassLine1V);
  ...
  const bassLine1B: string[] = bassArray1B(bassPart4, bassLine1C);
  const bassLine2B: string[] = bassArray2C(bassPart3, bassLine1B);
  const bassLine3B: string[] = bassArray3C(bassPart2, bassLine1V);
  const bassLine4B: string[] = bassArray4C(bassPart1, bassLine1V);
